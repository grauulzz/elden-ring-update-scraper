...
case class CssQueryStringWithHtmlTag(query: String, htmlTag: HtmlTag)
    extends QueryString
case class CssQueryStringWithHtmlTagList(
    query: String,
    htmlTagList: List[HtmlTag]
) extends QueryString
