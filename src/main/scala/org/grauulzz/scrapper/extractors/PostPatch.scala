...
object PostPatch {
  ...
  val tableCells: immutable.Seq[Element] =
    tableRows.tail.flatMap(_ >> elementList("td"))
  ...
  def getTableHeadersAndCells: immutable.Seq[(String, String)] =
    getTableHeaders.zip(getTableCells)
}
