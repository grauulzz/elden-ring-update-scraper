...
/** example usage: doc >> extractor(<cssQuery>, <contentExtractor>,
  ...
  *
  * contentExtractor: the content to be extracted from the selected elements,
  * e.g. the element objects themselves, their text, a specific attribute, form
  * data;
  *
  * contentParser: an optional parser for the data extracted in the step above,
  * such as parsing numbers and dates or using regexes. (contentParse date ex:
  * asLocalDate("yyyy-MM-dd")
  *
  * @param doc
